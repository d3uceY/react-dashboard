...
export default function FirstSectionDashBoard() {
    return (
        <div className='relative z-10 flex gap-9 max-w-[950px] border justify-between mx-auto'>
            <div className='first-box relative z-10 max-w-[300px] pt-8 pb-6 px-4 bg-white rounded-3xl'>
                <h2 className='text-2xl text-very-dark-blue mb-5 align-center'>Upgrade your Account</h2>
            ...
            <div className='bg-white max-w-2xl p-6 rounded-3xl'>
